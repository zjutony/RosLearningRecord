...
class PerRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type PerRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type PerRequest
    let len;
    let data = new PerRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new PerRequest(null);
...
class PerResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type PerResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type PerResponse
    let len;
    let data = new PerResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new PerResponse(null);
...
module.exports = {
  ...
  datatype() { return 'topic_node/Per'; }
};
